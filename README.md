...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsonrpcclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7829&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsonrpcclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsonrpcclient` can be installed with:

```
conda install jsonrpcclient
```

It is possible to list all of the versions of `jsonrpcclient` available on your platform with:
